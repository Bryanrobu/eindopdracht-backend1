                ...
                <div class="grid">
                    <div class="card">
                        ...
                        <div class="card-content">
                            ...
                            <p class="card-description">Onze signature burger met 100% lokaal rundvlees, oude kaas en
                                onze geheime Waalsaus.</p>
                    ...
                    <div class="card">
                        ...
                        <div class="card-content">
                            ...
                            <p class="card-description">Met romige truffelmayonaise, gegrilde paddenstoelen en verse
                                rucola.</p>
                            <a href="#" class="btn btn-primary btn-block">Bestellen</a>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-image">
                            <img src="https://images.unsplash.com/photo-1594212699903-ec8a3eca50f5?q=80&w=800"
                                alt="Spicy River">
                        </div>
                        <div class="card-content">
                            <div class="card-header">
                            ...
                            <p class="card-description">Een pittige ervaring met jalapeños, cheddar en onze huisgemaakte
                                hot-sauce.</p>
                            <a href="#" class="btn btn-primary btn-block">Bestellen</a>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="about-grid">
                    <div class="about-content">
                        ...
                        <p class="mb-4">
                            Wij werken alleen met verse, lokale ingrediënten. Onze burgers worden dagelijks vers
                            gedraaid en onze broodjes worden elke ochtend gebakken door de lokale bakker.
                        </p>
